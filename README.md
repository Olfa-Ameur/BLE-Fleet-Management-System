...
Designed and developed an embedded Bluetooth Low Energy (BLE) gateway enabling secure wireless driver identification for an existing fleet management device.
...
The solution demonstrated reliable communication between the BLE gateway and the existing fleet management device while validating secure authentication and real-time GPS data exchange.
