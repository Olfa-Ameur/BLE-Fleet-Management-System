...
#include "ble_types.h"        // pour tBleStatus
...
{
  /* Svc_Gestion_Flotte */
  CUSTOM_STM_CHAR_IDENTIFIANT,
  CUSTOM_STM_CHAR_NOTIF_GPS,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* Char_Identifiant */
  CUSTOM_STM_CHAR_IDENTIFIANT_WRITE_EVT,
  /* Char_Notif_GPS */
  CUSTOM_STM_CHAR_NOTIF_GPS_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_CHAR_NOTIF_GPS_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeChar_Identifiant;
extern uint16_t SizeChar_Notif_Gps;
